...
<section class="section core-services-section">
    <div class="container">
        ...
        <div class="grid-2 stagger-container mt-xl">
            ...
            echo render_service_card($events_icon, 'Events Planning & Management', 'We organize, plan, and manage your events smoothly from start to finish, ensuring all catering and setup details align perfectly with your vision.');
            ?>
        </div>
    </div>
</section>
