...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let navbarStart = navbar ? navbar.offsetTop : 0;

    const syncStickyNavbar = () => {
        if (!navbar) {
            return;
        }

        navbar.classList.toggle('is-stuck', window.scrollY > navbarStart);
    };
