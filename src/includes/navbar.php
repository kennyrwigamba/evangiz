...
<header class="navbar-wrapper">
    <div class="container navbar-container">
        <a href="<?php echo url('/'); ?>" class="navbar-logo-sticky" aria-label="Evangiz Restaurant Home">
            <img src="<?php echo url('/image/logo/logo-footer.png'); ?>" alt="Evangiz Restaurant">
        </a>
        ...
        <button class="navbar-toggle" id="mobile-menu-toggle" aria-label="Toggle Navigation" aria-controls="navbar-menu-container" aria-expanded="false">
