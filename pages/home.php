    ...
    <div class="container hero-container text-center">
        <div class="hero-content animate-slide-up">
            <h1 class="hero-title">
                ...
                <span>Where Every Flavor</span> <span class="font-italic hero-title-accent"><i> Tells A Story!</i></span>
            </h1>
...
<section class="section menu-preview-section menu-preview-section--tight">
    ...
    <div class="container menu-preview-inner">
        ...
        <div class="menu-tabs-container animate-scroll-reveal menu-tabs-container--spaced">
            <?php $is_first = true; ?>
    ...
    <div class="container">
        <div class="grid-2 catering-showcase-grid align-items-center">
            ...
            <div class="catering-showcase-content animate-scroll-reveal">
                ...
                <div class="menu-title-wave menu-title-wave--mb-md"></div>
